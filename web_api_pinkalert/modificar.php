...
try {
    ...
    $stmt = $conn->prepare("call bd_sistema_login.sp_actualizar_usuario(:id,:nombre, :apPaterno, :apMaterno, :email,:telefono);");
    ...
    $response = ["error" => "Error al modificar el usuario: " . $e->getMessage()];
    echo json_encode($response);
}
